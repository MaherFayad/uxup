export const ProjectContent = [
  {
    ...
    tags: ["Habit Tracking", "Mobile App", "Gamification"],
    Overview: "To design a mobile app that uses gamification aspects, to help users stay on their daily habits chasing after the rewards the app gives them, while also addressing their internal motivations ",
    Epic: `              <p className="uxup-fs-paragraph uxup-color-neutral-200">
              ...
              <div className="col-12">
                <div className="row g-3 p-4">
                  <ul>
                    ...
                    <li className="my-3 my-md-5">
                      <strong>Personal reminders and prompts</strong> that echo the app  grand vision, subtly woven into the user interface, to constantly realign user actions with the overarching purpose.
                    </li>
                    <li className="my-3 my-md-5">
                      <strong>Inclusive language and imagery</strong> throughout the app that resonates with the epic narrative, making every interaction a reinforcement of the user vital role within the app ecosystem.
                    </li>
                  </ul>
                  `,
    Development: `                  <div className="row p-4">
                  <p className="uxup-fs-paragraph uxup-color-neutral-200 mt-3 mb-5">
                    ...
                    <p className="uxup-fs-paragraph uxup-color-neutral-200 mt-3 mb-0">
                    Enhancing these core drives requires a careful balance between motivation and user experience, ensuring that each element contributes to a cohesive, engaging, and rewarding journey for the user.
                    </p>
                  </div>
